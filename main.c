...
void summing_amplifier(int vMinus, int vPlus);

void inverting_amplifier(int vMinus, int vPlus);

void non_inverting_amplifier(int vMinus, int vPlus);

float print_questions(float variables_in[], char *question[], int size, bool require_positive);
...
int main(void) {
    ...
    do {
        ...
        if (amp_op == 1) {
            summing_amplifier(vMinus, vPlus);
        } else if (amp_op == 2) {
...
void summing_amplifier(int vMinus, int vPlus) {
    ...
    print_questions(resistors, resistor_questions, 3, true);
    print_questions(voltages, voltage_questions, 2, false);
...
float print_questions(float variables[], char *question[], int size, bool require_positive) {
...
void gain(float resistors[], int length, bool is_invert) {
    ...
    for (int i = 0; i < length; i++) {
        ...
        printf("\nThe gain for input %i is: %.2f.", i + 1, gain);
    }
}
